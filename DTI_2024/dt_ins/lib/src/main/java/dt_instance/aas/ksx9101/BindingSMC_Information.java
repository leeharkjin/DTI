...
import java.util.List;
public class BindingSMC_Information {
	
	public static final Logger log = LoggerFactory.getLogger(BindingSMC_Information.class);
...
//	
	...
	public BindingSMC_Information(DefaultSubmodelElementCollection value, BindingType type, DefaultReference refelement) {
		this();
		this._value = value;
		this._type = type;
