...
import java.util.List;
public class BindingSMC_AI {
	
	public static final Logger log = LoggerFactory.getLogger(BindingSMC_AI.class);
...
//	private static final String DEF_TBL_COL_MODIFIERID = "MODIFIERID";
	...
	private static final String TABLE_SUBPREFIX = "AIINFO_";
...
//	
	...
	public BindingSMC_AI(DefaultSubmodelElementCollection value, BindingType type, DefaultReference refelement) {
		this();
		this._value = value;
		this._type = type;
