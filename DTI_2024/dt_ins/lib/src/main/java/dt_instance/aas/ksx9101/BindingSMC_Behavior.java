...
import java.util.List;
public class BindingSMC_Behavior {
	
	public static final Logger log = LoggerFactory.getLogger(BindingSMC_Behavior.class);
...
//	private static final String DEF_TBL_COL_MODIFIERID = "MODIFIERID";
	...
	private static final String TABLE_SUBPREFIX = "BEHAVIORINFO_";
...
//	
	...
	public BindingSMC_Behavior(DefaultSubmodelElementCollection value, BindingType type, DefaultReference refelement) {
		this();
		this._value = value;
		this._type = type;
