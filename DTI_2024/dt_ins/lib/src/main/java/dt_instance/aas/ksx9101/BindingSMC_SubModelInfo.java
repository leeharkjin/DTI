...
import java.util.List;
public class BindingSMC_SubModelInfo {
	
	public static final Logger log = LoggerFactory.getLogger(BindingSMC_SubModelInfo.class);
...
//	
	...
	public BindingSMC_SubModelInfo(DefaultSubmodelElementCollection value, BindingType type, DefaultReference refelement) {
		this();
		this._value = value;
		this._type = type;
